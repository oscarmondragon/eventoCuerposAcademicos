                                    ...
                                    <div id="accordion-open-body-2" class="hidden"
                                        ...
                                        <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                                            <label for="helper-text"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lider</label>
                                            <x-secondary-button class="ms-3"
                                        ...
                                        <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                                            ...
                                            <ul class="ps-5 text-gray-500 list-disc dark:text-gray-400">
                                                <li><a href="https://flowbite.com/pro/"
                                                        class="text-blue-600 dark:text-blue-500 hover:underline">Integrante
                                                        1</a></li>
                                            ...
                                            <label for="message"
                                                class="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-white">Descripción
                                                de su principal línea de generación y aplicación del
                                                conocimiento</label>
                                            <textarea id="message" rows="4"
                                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Leave a comment..."></textarea>
                                        ...
                                        <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                                            ...
                                            <form class="max-w-lg mx-auto">
                                                ...
                                                <div class="mt-1 text-sm text-gray-500 dark:text-gray-300"
                                                    id="user_avatar_help">Importante: Es necesario subir tu comprobante
                                                    de pago para ser considerado como participante.</div>
                                            </form>
                                        </div>
                                    </div>
                                </div>
